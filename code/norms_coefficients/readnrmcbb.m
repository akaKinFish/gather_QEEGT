function [mncoefPA, stdcoefPA, mncoefPR, stdcoefPR, mncoefFM, stdcoefFM, state, pgcorrect, freqres, nrm_band_index] = readnrmcBB(nrmbdfname, age)

    %%The file storing rules has an SGTE structure    %%array[1..100] of char // para cualquier cosa
    %%state
    %%pgcorrect
    %%nder
    %%nages
